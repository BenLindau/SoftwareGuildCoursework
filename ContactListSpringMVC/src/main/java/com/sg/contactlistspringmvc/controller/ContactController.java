...
public class ContactController {
    ...
    @RequestMapping(value = "/displayContactDetails", 
    ...
    @RequestMapping(value="/displayEditContactForm", 
            method = RequestMethod.GET) 
    ...
    @RequestMapping(value = "/editContact", 
            method = RequestMethod.POST)
    public String editContact(@Valid @ModelAttribute("contact") Contact contact,
