 ...
 private static long contactIdCounter = 0;
    ...
    public List<Contact> searchContacts(Map<SearchTerm, String> criteria) {
        ...
        if (firstNameSearchCriteria == null ||
            ...
            firstNameMatchPredicate = (c) -> 
            c.getFirstName().equals(firstNameSearchCriteria);
        }
        ...
        if (lastNameSearchCriteria == null ||
            ...
            lastNameMatchPredicate = (c) -> 
            c.getLastName().equals(lastNameSearchCriteria);
        }
        ...
        if (companySearchCriteria == null ||
            ...
            companyMatchPredicate = (c) -> 
            c.getCompany().equals(companySearchCriteria);
        }
        ...
        if (phoneSearchCriteria == null ||
            ...
            phoneMatchPredicate = (c) -> 
            c.getPhone().equals(phoneSearchCriteria);
        }
        ...
        if (emailSearchCriteria == null ||
            ...
            emailMatchPredicate = (c) -> 
            c.getEmail().equals(emailSearchCriteria);
        }
