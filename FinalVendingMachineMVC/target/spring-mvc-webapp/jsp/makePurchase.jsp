...
<html>
    ...
    <body>
      <div>
        <h1 id='titleHeader'>Make Purchase</h1>
        <hr/>
                 ...
                 <div class='container' id='selection'>
                    <div>
                      <label id="add-item">Item:</label>
                        ...
                        <p>
                        <a href="makePurchase?currentId=${item.itemId}&change=${change}"  class='btn btn-default' type="submit" class="btn-default"   id="makePurchase" >Vend Item</a>
