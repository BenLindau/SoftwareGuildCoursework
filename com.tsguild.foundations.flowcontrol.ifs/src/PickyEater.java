...
public class PickyEater {
 public static void main(String[] args) {
        ...
        if (hasSpinach.equals("y") || funnyName.equals("y")) {
         ...
         if (isBroccoli.equals("y") || funnyName.equals("y")) {
            System.out.println("There's no way that'll get eaten.");
        }
          if (chocolatedCovered.equals("y") || funnyName.equals("n")) {
            System.out.println("He will eat that.");
        }
           if (cheeseCovered.equals("y") || funnyName.equals("n")) {
            System.out.println("He will eat that.");
        }
            if (butterPats > 2 || funnyName.equals("n")) {
            System.out.println("He will eat that.");
        }
            if (timesFried > 1 || funnyName.equals("n")) {
            System.out.println("He will eat that.");
            }
 }
}
